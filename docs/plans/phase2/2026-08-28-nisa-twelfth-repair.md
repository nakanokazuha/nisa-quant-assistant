...
**Files:**
- Modify: `src/nisa_quant/database_schema.py`, `src/nisa_quant/watchlist.py`
...
**Files:**
- Modify: `src/nisa_quant/source_records.py`, `src/nisa_quant/portfolio_metrics.py`, `src/nisa_quant/recommendation_journal.py`, `src/nisa_quant/watchlist.py`, `src/nisa_quant/broker_csv_import.py`, existing valid fixtures/tests as needed
- Test: `tests/test_twelfth_repair.py`
